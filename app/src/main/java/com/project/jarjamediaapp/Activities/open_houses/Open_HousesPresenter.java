...
import com.project.jarjamediaapp.Activities.social_profiles.Social_ProfilesContract;
import com.project.jarjamediaapp.Base.BasePresenter;
import com.project.jarjamediaapp.Base.BaseResponse;

import retrofit2.Call;

public class Open_HousesPresenter extends BasePresenter<Open_HousesContract.View> implements Open_HousesContract.Actions {

    Call<BaseResponse> _call;


    public Open_HousesPresenter(Open_HousesContract.View view) {
        super(view);
    }
